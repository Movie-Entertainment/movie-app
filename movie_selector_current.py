    ...
    def start_program(self):
        ...
        while loop:  ## While loop which will keep going until loop = False
            ...
            if choice==1:     
                ...
                # print(f'{youtube.lookup_youtube(self.result)[0]}\n')
                # print(f'{youtube.lookup_youtube(self-result)[1]}\n')
                # print(f'{youtube.lookup_youtube(self.result)[2]}')
                ...
                print(f'{amazon.lookup_amazon(self.result)[0]}\n')
                print(f'{amazon.lookup_amazon(self-result)[1]}\n')
                print(f'{amazon.lookup_amazon(self.result)[2]}')
